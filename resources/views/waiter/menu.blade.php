...
<div class="min-h-screen bg-white pb-24" x-data="{
    ...
    <div class="max-w-7xl mx-auto px-4 pt-4 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <!-- Order Summary (Sidebar on Desktop, Bottom on Mobile) - Hidden on Mobile & Tablet -->
        <div class="hidden lg:block lg:col-span-1 bg-gray-50 rounded-[2rem] p-6 h-fit sticky top-24 border border-gray-100">
    ...
    <div x-show="cart.length > 0"
         ...
         class="lg:hidden p-4 bg-white border-t border-gray-150 shadow-[0_-10px_25px_-5px_rgba(0,0,0,0.05)] fixed bottom-0 left-0 right-0 z-40 shrink-0">
